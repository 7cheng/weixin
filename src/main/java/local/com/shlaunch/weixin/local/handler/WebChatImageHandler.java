/**
 * @(#)WebChatImageHandler.java 14-4-16
 *
 ...
 * @since 1.0
 */
public class WebChatImageHandler extends AbstractWebChatHandler {
    ...
    private final String MsgType = WebChatDispatchHandler.IMAGE;
}
